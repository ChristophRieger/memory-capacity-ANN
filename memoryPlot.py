...
plt.plot(N_recurrent, [i / j for i, j in zip(number_of_patterns_recurrent, [2 * x**2 for x in N_recurrent])], marker = 'o', ms = 4, label='recurrent layer (2 steps) + custom loss', color='red')
plt.plot(N_recurrent_2, [i / j for i, j in zip(number_of_patterns_recurrent_2, [2 * x**2 for x in N_recurrent_2])], marker = 'o', ms = 4, label='recurrent layer (3 steps) + custom loss', color='black')
